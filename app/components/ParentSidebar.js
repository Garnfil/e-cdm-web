                ...
                <ul className='flex flex-col gap-2 w-full px-4 instructor-sidebar-list'>
                    ...
                    <li>
                        <Link href={'/guardian/announcements'}>
                            <span className="flex-grow"><i class="bi bi-megaphone-fill mr-2"></i> Announcements</span>
                        </Link>
                    </li>
                    <li>
                        <Link href={'/guardian/children'}>
                            <span className="flex-grow"><i class="bi bi-people-fill mr-2"></i> Children</span>
                        </Link>
                    </li>
                </ul>
            </div>
