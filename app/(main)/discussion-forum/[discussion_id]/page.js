...
const DiscussionDetails = () => {
    ...
    const fetchDiscussionDetails = async (session, discussion_id) => {
        try {
            const response = await axios.get(`http://192.168.100.44:8000/api/discussions/${discussion_id}`, {
                headers: {
    ...
    const handleAddComment = () => {
        ...
        axios.post(`http://192.168.100.44:8000/api/discussions/${discussion_id}/comments`, body, {
            headers: {
                "Accept": "application/json",
    ...
    const handleVote = (voteType) => {
        ...
        axios.post(`http://192.168.100.44:8000/api/discussions/${discussion_id}/votes`, body, {
            headers: {
                "Accept": "application/json",
                "Authorization": `Bearer ${authSession?.token}`,
            }
