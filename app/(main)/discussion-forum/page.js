...
export default function DiscussionForumPage() {
    ...
    const fetchDiscussions = async (session) => {
        try {
            const response = await axios.get(`https://my-cdm.godesqsites.com/api/discussions`, {
                headers: {
    ...
    const fetchUserInstitute = async () => {
        try {
            const response = await axios.get(`https://my-cdm.godesqsites.com/api/institutes/${authSession?.user?.institute_id}`, {
                headers: {
                    "Accept": "application/json",
    ...
    const fetchUserCourse = async () => {
        try {
            const response = await axios.get(`https://my-cdm.godesqsites.com/api/courses/${authSession?.user?.course_id}`, {
                headers: {
                    "Accept": "application/json",
                    "Authorization": `Bearer ${authSession.token}`,
                }
    ...
    const handleSubmitDiscussion = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`https://my-cdm.godesqsites.com/api/discussions`, formData, {
                headers: {
                    "Accept": "application/json",
                    "Authorization": `Bearer ${authSession?.token}`,
