        ...
        <div className='flex gap-4 lg:gap-6 mb-6'>
                ...
                <div className='w-full xl:h-[350px] overflow-hidden bg-white border border-black py-8 px-5 hover-shadow rounded'>
                    <div className='flex justify-between items-start'>
                        ...
                        <div className='w-[40%]'>
                            ...
                            <button className='btn btn-primary rounded-full py-3 text-sm px-4 mt-5'>View All Schedule <i class="bi bi-arrow-right"></i></button>
                        </div>
                    </div>
                </div>
            ...
            <div className='w-[30%] h-full flex flex-col gap-3'>
                ...
                <div className='bg-white hover-shadow border-black rounded border hover:-translate-x-0.5 duration-300 p-6 flex flex-col gap-3'>
                    <h4 class="font-medium">Class Schedule</h4>
                    <div className='flex flex-col gap-3'>
                        <div class="today [&amp;.today_.icon-today]:block [&amp;.today_.text-today]:text-primary dark:[&amp;.today_.text-today]:text-primary relative flex flex-start gap-3">
                            <div>
                                <div class="py-2 w-12 bg-primary border border-black text-white rounded flex flex-col items-center gap-0.5 text-today">
                                    <span class="text-sm">May</span>
                                    <span class="text-xl font-bold leading-none">15</span>
                                </div>
                            </div>
                            <div class="flex flex-col gap-1.5">
                                <h4 class="text-sm font-medium">Class in BSIT-4D</h4>
                                <div class="text-xs"><i class="bi bi-clock me-1"></i>14:30 PM - 15:00 PM</div>
                                <div class="text-xs text-neutral-500"><i class="bi bi-camera-video me-1"></i>
                                    Video Conference</div>
                            </div>
                        </div>
                        <div class="today [&amp;.today_.icon-today]:block [&amp;.today_.text-today]:text-primary relative flex flex-start gap-3">
                            <div>
                                <div class="py-2 w-12 bg-primary border border-black text-white rounded flex flex-col items-center gap-0.5 text-today">
                                    <span class="text-sm">May</span>
                                    <span class="text-xl font-bold leading-none">15</span>
                            ...
                            <div class="flex flex-col gap-1.5">
                                <h4 class="text-sm font-medium">Class in BSIT-3F</h4>
                                <div class="text-xs"><i class="bi bi-clock me-1"></i>14:30 PM - 15:00 PM</div>
                                <div class="text-xs text-neutral-500"><i class="bi bi-backpack me-1"></i>
                                    Face to Face</div>
                            </div>
                        </div>
                    </div>
