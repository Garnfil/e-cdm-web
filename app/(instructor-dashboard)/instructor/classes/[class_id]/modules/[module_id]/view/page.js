...
export default function ViewModulePage() {
    ...
    const fetchModule = async (session) => {
        try {
            const response = await axios.get(`https://app-digital-cdm.godesqsites.com/api/modules/${module_id}`, {
                headers: {
    ...
    const handleUploadAttachmentSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`https://app-digital-cdm.godesqsites.com/api/modules/attachments/single-upload`, formData, {
                headers: {
                    "Accept": "application/json",
    ...
    const handleUpdateModule = async () => {
        try {
            const response = await axios.put(`https://app-digital-cdm.godesqsites.com/api/modules/${moduleDetails.id}`, moduleDetails, {
                headers: {
                    "Accept": "application/json",
                    "Authorization": `Bearer ${authSession.token}`
                }
