                            ...
                            <div className="border border-black bg-white p-4" style={{ height: "calc(100vh - 200px)" }}>
                                ...
                                {(
                                    selectedSubmissionAttachment?.attachment_type === "file" ? (
                                        <div className='m-3'>
                                            <a target='_blank' href={`http://192.168.56.1:8000/assets/uploads/student_submission_attachments/${selectedSubmissionAttachment.attachment_name}`} className='btn btn-primary'>View File <i className="bi bi-file-earmark"></i></a>
                                        </div>
                                    ) : (
