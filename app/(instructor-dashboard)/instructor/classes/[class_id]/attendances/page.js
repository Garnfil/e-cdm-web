...
export default function ClassAttendancePage() {
    ...
    const fetchAttendances = async (session) => {
        try {
            const response = await axios.get(`http://192.168.100.110:8000/api/attendances/classes/${class_id}`, {
                headers: {
    ...
    const handleNewAttendanceSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`http://192.168.100.110:8000/api/attendances`, formData, {
                headers: {
                    "Accept": "application/json",
    ...
    const handleDeleteAttendance = async (attendanceId) => {
        try {
            const response = await axios.delete(`http://192.168.100.110:8000/api/attendances/${attendanceId}`, {
                headers: {
                    "Accept": "application/json",
                    "Authorization": `Bearer ${authSession.token}`,
                }
