...
export default function ClassAttendancePage() {
    ...
    const fetchAttendances = async (session) => {
        try {
            const response = await axios.get(`https://my-cdm.godesqsites.com/api/attendances/classes/${class_id}`, {
                headers: {
    ...
    const handleNewAttendanceSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`https://my-cdm.godesqsites.com/api/attendances`, formData, {
                headers: {
                    "Accept": "application/json",
    ...
    const handleDeleteAttendance = async (attendanceId) => {
        try {
            const response = await axios.delete(`https://my-cdm.godesqsites.com/api/attendances/${attendanceId}`, {
                headers: {
                    "Accept": "application/json",
                    "Authorization": `Bearer ${authSession.token}`,
                }
