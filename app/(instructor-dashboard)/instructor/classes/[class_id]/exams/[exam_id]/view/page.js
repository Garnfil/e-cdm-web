...
export default function ViewExamPage() {
    ...
    const fetchExamDetails = async (session) => {
        try {
            const response = await axios.get(`https://my-cdm.godesqsites.com/api/school-works/${exam_id}`, {
                headers: {
                    "Accept": "application/json",
                    "Authorization": `Bearer ${session.token}`
                }
    ...
    const handleUpdateExam = async () => {
        try {
            const response = await axios.put(`https://my-cdm.godesqsites.com/api/exams/${examDetails.exam_id}`, examDetails, {
                headers: {
                    "Accept": "application/json",
                    "Authorization": `Bearer ${authSession.token}`
                }
