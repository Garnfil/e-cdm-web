                ...
                <div>
                    ...
                    <nav class="breadcrumb" aria-label="Breadcrumb">
                        <ol class="list-none text-sm p-0 inline-flex">
                            ...
                            <li class="flex pdskdmsdnjw">
                                <span class="mx-2">›</span>
                                <a href="#" class="hover:underline font-bold">Create Class</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                <Link href={'/instructor/classes'} className='btn btn-primary hover-shadow'><i class="bi bi-arrow-left"></i> Back to List</Link>
            </div>
