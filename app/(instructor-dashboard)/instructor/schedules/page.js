...
export default function SchedulePage() {
    ...
    const fetchInstructorSchedules = async (session) => {
        try {
            const response = await axios.get(`http://127.0.0.1:8000/api/instructors/${session.user.id}/class-schedules`, {
                headers: {
    ...
    const fetchInstructorClasses = async (session) => {
        try {
            const response = await axios.get(`http://127.0.0.1:8000/api/instructors/${session.user.id}/classes`, {
                headers: {
                    "Accept": "application/json",
                    "Authorization": `Bearer ${session.token}`,
                }
    ...
    const handleClassScheduleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`http://127.0.0.1:8000/api/class-schedules`, formData, {
                headers: {
                    "Accept": "application/json",
                        ...
                        <DialogHeader>
                            ...
                            <form className='my-5' onSubmit={handleClassScheduleSubmit}>
                                ...
                                <div className='form-group'>
                                    ...
                                    <label htmlFor='has-schedule-date' className='ml-2 inline-block'>Has Schedule Date</label>
                                </div>
                                ...
                                <div className={`mb-3 ${isScheduleDate ? 'hidden' : 'block'}`}>
                                    ...
                                    }} isMulti name='days_of_week[]' options={daysOfWeekOptions} />
                                </div>
