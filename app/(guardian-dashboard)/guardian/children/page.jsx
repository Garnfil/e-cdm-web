                        ...
                        <div class="flex flex-col mt-3">
                            {students?.length > 0 ? (
                                students?.map((student) => (
                                    <div
                                        class="py-1.5 px-2 rounded border border-black flex items-center justify-between gap-3 hover:bg-green-50 cursor-pointer"
                                    ...
                                    >
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <span class="text-xs">{student.student_id}</span>
                                            </div>
                                        </div>
                                    </div>
                                ))
                            ...
                            <div class="border-black rounded-lg border bg-gradient-to-r from-green-800 to-secondary overflow-hidden">
                                ...
                                <div class="flex flex-col sm:flex-row items-center sm:gap-4 mb-2">
                                    ...
                                    <div class="flex sm:inline-flex items-center justify-center">
                                        <a
                                            href="#"
                                            class={`active ${currentStudentTab == "profile" ? "text-secondary" : "text-white"} flex items-center py-2 px-3 gap-1.5 font-medium hover:text-secondary`}
                                    ...
                                    <span class="hidden md:block">School Works</span>
                                        ...
                                        <a
                                            href="#"
                                            class={`active ${currentStudentTab == "grades" ? "text-secondary" : "text-white"} flex items-center py-2 px-3 gap-1.5 font-medium hover:text-secondary`}
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="w-full overflow-y-auto">
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <th scope="row" class="text-start py-2">
                                                            Full Name :
                                                        </th>
                                                        <td class="text-neutral-500 dark:text-neutral-400 ps-6 py-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-neutral-500 dark:text-neutral-400 ps-6 py-2">{currentStudent.student_id}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" class="text-start py-2">
                                                            Email :
                                                        </th>
                                                        <td class="text-neutral-500 dark:text-neutral-400 ps-6 py-2">{currentStudent.email}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" class="text-start py-2">
                                                            Year Level & Section :
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-neutral-500 dark:text-neutral-400 ps-6 py-2">{currentStudent?.institute?.name}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" class="text-start py-2">
                                                            Course :
                                                        </th>
                                                        <td class="text-neutral-500 dark:text-neutral-400 ps-6 py-2">{currentStudent?.course?.name}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        {selectedStudentGrades.length > 0 ? (
                                            selectedStudentGrades.map((class_grade) => (
                                                <tr class="*:px-6 *:py-4 *:whitespace-nowrap text-center">
                                                    <td>
                                                        <div class="text-start">{class_grade?.classroom?.title}</div>
                                                    </td>
                                                    <td>
                                                        <span class="text-neutral-500 dark:text-neutral-300 text-sm">
